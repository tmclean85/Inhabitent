 ...
 * @author    Trevor McLean <trevor.a.mclean@gmail.com>
 * @license   GPL-2.0+
 * @link      http://inhabitent.com
 * @copyright 2017 Trevco
 *
 * @wordpress-plugin
 * Plugin Name:       Inhabitent Business Hours Widget
 * Plugin URI:        http://inhabitent.com
 * Description:       A handy business hours widget for Inhabitent
 * Version:           1.0.0
	...
	public function __construct() {
		...
		parent::__construct(
			...
			array(
				...
				'description' => 'Add business hours of Inhabitent store.'
			)
		);
